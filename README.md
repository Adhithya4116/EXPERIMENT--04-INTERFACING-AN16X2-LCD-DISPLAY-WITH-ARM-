...
int main(void)
{
  ...
  Lcd_PortType ports[] = { GPIOA, GPIOA, GPIOA, GPIOA };
     ...
     Lcd_cursor(&lcd, 0,1);
     Lcd_string(&lcd, "ADHITHYA");
     Lcd_cursor(&lcd, 1,1);
     Lcd_string(&lcd, "212222230007");
  while (1)
  {
	  for ( int x = 1; x <= 200 ; x++ )
	 	  { Lcd_cursor(&lcd, 2,7);
...
![offf](https://user-images.githubusercontent.com/118707079/235148743-07bc5362-ce3a-4887-8c60-970912b9e3ec.png)

 ![Screenshot (28)](https://user-images.githubusercontent.com/118707079/235146957-d9ef471e-c0c1-4e10-b3b9-6885056fb3a1.png)

 ## CIRCUIT DIAGRAM (EXPORT THE GRAPHICS TO PDF AND ADD THE SCREEN SHOT HERE): 
 
 ![circuit](https://user-images.githubusercontent.com/118707079/235148331-ed14225f-8a39-4a8b-8d9c-271f32fd1a1c.png)
